...
[![Version](https://img.shields.io/badge/version-0.1.0-blue.svg)](https://github.com/ghitatruongle/ShieldGhita)
...
- Download `ShieldGhita_Setup_v0.1.0.exe` and execute with **Administrator** privileges.
...
- Tải tệp cài đặt `ShieldGhita_Setup_v0.1.0.exe` và chạy với quyền **Administrator**.
