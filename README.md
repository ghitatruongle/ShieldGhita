...
[![Version](https://img.shields.io/badge/version-0.1.1--alpha-blue.svg)](https://github.com/ghitatruongle/ShieldGhita)
...
- Download `ShieldGhita_Setup_v0.1.1-alpha.exe` and execute with **Administrator** privileges.
...
- Tải tệp cài đặt `ShieldGhita_Setup_v0.1.1-alpha.exe` và chạy với quyền **Administrator**.
